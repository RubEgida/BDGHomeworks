...
public class Statements {
    ...
    /**
     * Check x is in the given range or not.
     * @param x
     */
    ...
    /**
     * Check x is divisible by 5 and 7 with no remainder.
     * @param x
     */
    ...
    /**
     * Check if x is a three-digit number, the second digit is 7 or not.
     * @param x
     */
    ...
    /**
     * Check with (x,y) coordinates point in K(0,0)(R = 5) circle or no.
     * @param x
     * @param y
     */
    ...
    /**
     * Check this x year is leap or no.
     * @param x
     */
    ...
    /**
     * Method that prints the numbers 1 to 200 in the console.
     */
    ...
    /**
     * Method that prints the first digit of the x in the console.
     * @param x
     */
    ...
    /**
     * As long as x < 5 and y < 10 print x+y the phrase(x=1, y=0).
     */
    ...
    /**
     * With * symbol print in the console square.
     */
    public void square() {
    ...
    /**
     * Calculates the product of all two-digit even numbers [1-N].
     * @param N
     */
    ...
    /**
     * Receives a 5-digit integer and calculates the sum of the digits of that number.
     * @param x
     */
